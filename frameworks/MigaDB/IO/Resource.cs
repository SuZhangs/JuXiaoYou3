namespace Acorisoft.FutureGL.MigaDB.IO
{
    ...
    public enum ResourceProperty
    {
        ...
        Image_Horizontal_1080P_Padding = Image + 0x081,
        Image_Vertical_240P            = Image + 0x100,
        Image_Vertical_240P_Padding    = Image + 0x101,
        Image_Vertical_720P            = Image + 0x110,
        Image_Vertical_720P_Padding    = Image + 0x111,
        Image_Vertical_1080P           = Image + 0x120,
        Image_Vertical_1080P_Padding   = Image + 0x121,
        File                           = 0x00300,
