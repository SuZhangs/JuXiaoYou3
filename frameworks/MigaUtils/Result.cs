namespace Acorisoft.FutureGL.MigaUtils
{
    ...
    public class Result<TReason>
    {
        ...
        public static Result<TReason> Failed(TReason reason) => new Result<TReason>
        {
            IsFinished = false,
            Reason     = reason
        };
        ...
        /// 表示一个成功的结果。
        /// </summary>
        public static readonly Result<TReason> Successful = new Result<TReason> { IsFinished = true };
    }
