...
[Files]
Source: "E:\发行\橘小柚\dependencies\.Net5-x64.exe"; DestDir: "{app}"; Flags: dontcopy noencryption
...
begin
  ...
  ExtractTemporaryFile('.Net5-x64.exe');
  Result := True;
end;
var
...
begin
  ...
  try
    if not Exec(ExpandConstant('{tmp}\.Net5-x64.exe'), '/passive /norestart /showrmui /showfinalerror', '', SW_SHOW, ewWaitUntilTerminated, ResultCode) then
    begin
    ...
    DeleteFile(ExpandConstant('{tmp}\Net5-x64.exe'));
  end;
end;
